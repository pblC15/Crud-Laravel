...
<div class="col-5 m-auto">
  ...
  <form action="{{ route('createauthor.do')}}" method='post' name="formCad" id="formCad"> 
  @csrf 
  @method('post')
    ...
    <div class="form-group">
      <label for="id_country">Nacionalidade: </label>
      <select class="form-control" name="country" id="id_country" required="required">
        <option value=''></option>
    ...
    <div class="form-group">
      <label for="id_occupation">Ocupação: </label>
      <input type="text" class="form-control" name="occupation" id="id_occupation" placeholder="ex: Escritor, Poeta, Dramaturgo, Ator, Diretor" required="required">
    </div>
